...
const FAQ = () => {
  return (
    <div>
      <h3 className="lg:text-4xl text-3xl text-center font-semibold my-8">FAQ: Frequently Asked Question</h3>
      <hr className="lg:w-[50%] w-[90%] mx-auto border-2 my-1" />
      <div className="lg:grid grid-cols-2 gap-8 lg:mx-8 mx-3 mt-12 mb-[20%]">
        <div className="border-2 my-5 shadow-xl rounded-lg lg:p-5 p-2">
          <h2 className="lg:text-2xl text-xl mt-2 font-medium">What is the <mark style={{ backgroundColor: "cyan" }}>Web Development</mark>?</h2>
        ...
        <div className="border-2 my-5 shadow-xl rounded-lg lg:p-5 p-2">
          <h2 className="lg:text-2xl text-xl mt-2 font-medium">Why This <mark style={{ backgroundColor: "yellowgreen" }}>Course</mark>?</h2>
          <div className="divider my-2"></div>
          <p className="p-2">
        ...
        <div className="border-2 my-5 shadow-xl rounded-lg lg:p-5 p-2">
          <h2 className="lg:text-2xl text-xl mt-2 font-medium"><mark style={{ backgroundColor: "lightblue" }}>Benefits</mark> of Web Development</h2>
          <div className="divider my-2"></div>
          <p className="p-2">
        ...
        <div className="border-2 my-5 shadow-xl rounded-lg lg:p-5 p-2">
          <h2 className="lg:text-2xl text-xl mt-2 font-medium">Why Should I Learn <mark>Web Development</mark> ? </h2>
          <div className="divider my-2"></div>
          <p className="p-2">
            Web development has a number of pros: High earning potential, opportunity for growth, and flexibility are usually top of mind for most who get into the industry. Some of the challenges for people who pursue web development is the competitive nature of the job market.</p>
        </div>
      </div>
    </div>
  );
